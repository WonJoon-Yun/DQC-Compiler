...
class Gate:
    ...
    def pos1(self, value):
        self._pos1 = value
    def __str__(self):
        return f"Gate(layer_idx={self.layer_idx}, atom0={self.atom0}, atom1={self.atom1})"
    def __repr__(self):
        return self.__str__()
    @property
    def is_ccop(self):
    ...
    def done(self):
        ...
        can_be_done = all(dependency.is_done for dependency in self.dependency)
...
class Executable(Gate):
    def __init__(self,
                 ...
                 start_time = 0,
                 end_time = 0,):
        super().__init__(layer_idx, atom0, atom1, pos0, pos1, dependency, is_done)
